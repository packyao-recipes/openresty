...
a['description'] = 'openresty is a full-fledged web application server by bundling the standard nginx core, lots of 3rd-party nginx modules, as well as most of their external dependencies.'
a['depends'] = []
a['cwd'] = ''
a['env'] = {}
a['outputs'] = %w(deb rpm)
